...
Category research: [`docs/design/COMPETITIVE_UX_RESEARCH.md`](docs/design/COMPETITIVE_UX_RESEARCH.md)
Final page structure: [`docs/design/PRODUCT_DESIGN_BLUEPRINT.md`](docs/design/PRODUCT_DESIGN_BLUEPRINT.md)
...
Calm, premium, articulate, and trustworthy. It combines the warmth of an editorial reading product with the precision of an evidence tool. This is the closest fit to the Claude-inspired direction already captured in `DESIGN.md`, while retaining a distinct Resumide identity.
